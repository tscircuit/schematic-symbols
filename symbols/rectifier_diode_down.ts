...
export default modifySymbol({
  ...
  .labelPort("bottom1", ["3"]) // becomes left after rotation
  .labelPort("left1", ["4"]) // becomes up after rotation
  .labelPort("top1", ["1"]) // becomes right after rotation
  .labelPort("right1", ["2"]) // becomes down after rotation
