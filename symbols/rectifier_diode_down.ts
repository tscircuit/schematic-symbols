...
export default modifySymbol({
  ...
  .labelPort("bottom1", ["2"]) // becomes left after rotation
  .labelPort("left1", ["3"]) // becomes up after rotation
  .labelPort("top1", ["4"]) // becomes right after rotation
  .labelPort("right1", ["1"]) // becomes down after rotation
