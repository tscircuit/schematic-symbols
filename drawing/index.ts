...
export type Primitive = PathPrimitive | TextPrimitive | CirclePrimitive | BoxPrimitive;
...
export function text(text: string, options: Omit<TextPrimitive, "type" | "text">): TextPrimitive {
  return { type: "text", text, ...options };
}

export function circle(options: Omit<CirclePrimitive, "type">): CirclePrimitive {
